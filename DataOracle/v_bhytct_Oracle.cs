    ...
    public class v_bhytct_Oracle
    {
        ...
        public int f_insert(v_bhytct obj)
        {
            ...
            try
            {
                ...
                //PHAU THUAT KTC
                sql = "insert into "+schema+".v_bhytct(ID,STT,NGAY,MAKP,MADOITUONG,MAVP,SOLUONG,DONGIA,VAT,VATTU,SOTIEN,SOTHE,";
                sql+="GIAMUA,TRA,NGAYTRA,BHYTDUYET,BHYTTRA,IDTONGHOP,MAKPTHUCHIEN,GIA_BH,MIEN,MABS,NGAYUD,ID_KTCAO,IDNHOMBHYT,TILE) values ";
                sql+="({ID},{STT},{NGAY},{MAKP},{MADOITUONG},{MAVP},{SOLUONG},{DONGIA},{VAT},{VATTU},{SOTIEN},{SOTHE},";
                sql+="{GIAMUA},{TRA},{NGAYTRA},{BHYTDUYET},{BHYTTRA},{IDTONGHOP},{MAKPTHUCHIEN},{GIA_BH},{MIEN},{MABS},{NGAYUD},{ID_KTCAO},{IDNHOMBHYT},{TILE})";
        ...
        public int f_delete(long id)
        {
            ...
            try
            {
                ...
                string userid = AccessData.m_userid;
                //delete
                sql = "delete " + schema + ".v_bhytct where id={id} ";
