...
namespace MediIT115
{
    public partial class haison : UserControl
    {
        ...
        private string tieude()
        {
            ...
            {
                if (tu.Text == den.Text) s_title = "ngày " + tu.Text.Substring(0, 2) + " tháng " + tu.Text.Substring(3, 2) + " năm " + tu.Text.Substring(6, 4) + "";
                else s_title = "Từ ngày " + tu.Text + " đến ngày " + den.Text + "";
            }
            else if (cbbaocao.SelectedIndex == 1)
            {
                s_title = "tháng " + cbthang.Text + " năm " + cbnam.Value.ToString() + "";
            }
            else if (cbbaocao.SelectedIndex == 2)
            {
                s_title = "quý " + cbthang.Text + " năm " + cbnam.Value.ToString() + "";
            }
            else if (cbbaocao.SelectedIndex == 3)
            {
                s_title = "năm" + cbnam.Value.ToString() + "";
            }
            return s_title;
        }
