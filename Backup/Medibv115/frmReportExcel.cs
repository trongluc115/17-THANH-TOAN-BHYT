...
namespace MediIT115
{
	public class frmReportExcel : System.Windows.Forms.Form
	{
		//binh
        ...
        public frmReportExcel(LibBaocao.AccessData acc, System.Data.DataTable ta, string mMsg, string report)
		{
			InitializeComponent();
			dt=ta;d=acc;
			msg=mMsg;
        ...
        public frmReportExcel(LibBaocao.AccessData acc, System.Data.DataTable ta, string mMsg, string report, decimal soban)
        {
            InitializeComponent();
            dt = ta; d = acc;
            msg = mMsg;
        ...
        public frmReportExcel(LibBaocao.AccessData acc, System.Data.DataTable ta, string report, string s1, string s2, string s3, string s4, string s5, string s6)
        {
            InitializeComponent();
            d = acc; dt = ta;
        ...
        public frmReportExcel(LibBaocao.AccessData acc, System.Data.DataTable ta, string report, string s1, string s2, string s3, string s4, string s5, string s6, string s7, string s8, string s9, string s10)
		{
			InitializeComponent();
			d=acc;dt=ta;
        ...
        public frmReportExcel(LibBaocao.AccessData acc, System.Data.DataSet ta, string report, string s1, string s2, string s3, string s4, string s5, string s6, string s7, string s8, string s9, string s10, bool bsr)
        {
            InitializeComponent();
            d = acc; ds = ta;
            c1 = s1; c2 = s2; c3 = s3; c4 = s4; c5 = s5;
        ...
        public frmReportExcel(LibBaocao.AccessData acc, System.Data.DataTable ta, string report, string s1, string s2, string s3, string s4, string s5, string s6, string s7, string s8, string s9, string s10, string s11, string s12)
		{
			InitializeComponent();
            d = acc; dt = ta;
        ...
        public frmReportExcel(LibBaocao.AccessData acc, System.Data.DataTable ta, string report, string s1, string s2, string s3, string s4, string s5, string s6, string s7, string s8, string s9, string s10, string s11, string s12, decimal soban)
        {
            InitializeComponent();
            d = acc; dt = ta;
            c1 = s1; c2 = s2; c3 = s3; c4 = s4; c5 = s5; c6 = s6;
        ...
        public frmReportExcel(LibBaocao.AccessData acc, System.Data.DataTable ta, string s1, string s2, string report)
		{
			InitializeComponent();
			d=acc;
			dt=ta;
        ...
        public frmReportExcel(LibBaocao.AccessData acc, System.Data.DataTable ta, string report, string ngay, string nguoithu, string a1, string a2, string a3, string a4, string a5, string a6, string a7, string a8, string a9, string a10, string aloaibc)
		{
			InitializeComponent();
