...
namespace LibBaocao
{
    ...
    {
        public string Msg = "Báo cáo 2009";
        public static string Export_SQL = "";
        public static string m_userid="";
        public static string schema = "BV115";
        public static string s_makhuvuc = "";
        public static string s_tenkhuvuc = "";
      
     
        public static string _NHOM_CDHA = "";
        public static DateTime m_date_lock ;
        public static DateTime m_date_default ;
        ...
        private string m_db_schemaroot = "";// + user + "";
        private string vsql = "";
        ...
        public int nhom_duoc
        {
            get
            {
                try
                {
                    ds = get_data("select ten from " + user + ".thongso where id=166");
        ...
        public string thongso_sothe80()
        {
            ds = get_data("select ten from " + user + ".thongso where id=50 ");
            if (ds.Tables[0].Rows.Count > 0) return ds.Tables[0].Rows[0]["ten"].ToString().Trim();
            else return "";
        }
        public string thongso_sothe95()
        {
            ds = get_data("select ten from " + user + ".thongso where id=-50 ");
            if (ds.Tables[0].Rows.Count > 0) return ds.Tables[0].Rows[0]["ten"].ToString().Trim();
            else return "";
        ...
        public string thongso_vitri_sothe80(int nhom)
        {
            ds = get_data("select ten from " + user + ".d_thongso where id=53 and nhom=" + nhom);
            if (ds.Tables[0].Rows.Count > 0) return ds.Tables[0].Rows[0]["ten"].ToString().Trim();
            else return "";
        }
        public string thongso_sotien_sothe80(int nhom)
        {
            ds = get_data("select ten from " + user + ".d_thongso where id=51 and nhom=" + nhom);
            if (ds.Tables[0].Rows.Count > 0) return ds.Tables[0].Rows[0]["ten"].ToString().Trim();
            else return "";
        }
        public bool bGiaban_theodot(int d_nhom)
        {
            if (Mabv.Trim().Length>0 && Mabv.Substring(0, 3) == "701") return false;
            else
            {
        ...
        public string for_num_ngay(string ngay)
        {
            ...
            return "to_date(to_char(" + ngay + ", '" + f_ngay_yyyymmdd + "'), '" + f_ngay_yyyymmdd + "')";
        }
        ...
        private long get_capid1(int m_ma)
        {
            ...
            cmd.Parameters.Add("m_ma", OracleDbType.Decimal).Value = m_ma;
            ...
            if (irec == 0)
            {
                ...
                cmd.CommandType = CommandType.Text;
                cmd.Parameters.Add("m_ma", OracleDbType.Decimal).Value = m_ma;
                cmd.Parameters.Add("m_ten", OracleDbType.Varchar2, 20).Value = sComputer;
                cmd.Parameters.Add("m_computer", OracleDbType.Varchar2, 20).Value = sComputer;
                cmd.ExecuteNonQuery();
                cmd.Dispose();
            }
        ...
        public long get_capid1(int m_ma, string m_table)
        {
            ...
            if (irec == 0)
            {
                ...
                cmd.CommandType = CommandType.Text;
                cmd.Parameters.Add("m_ma", OracleDbType.Decimal).Value = m_ma;
                cmd.Parameters.Add("m_loai", OracleDbType.Varchar2, 20).Value = sComputer;
                cmd.ExecuteNonQuery();
                cmd.Dispose();
            }
        ...
        public string get_madstt(string tendstt)
        {
            ...
            try
            {
                ...
                cmd = new OracleCommand(sql, con);
                cmd.CommandType = CommandType.Text;
                cmd.Parameters.Add("tendstt", OracleDbType.NVarchar2).Value = tendstt.Trim();
                dest = new OracleDataAdapter(cmd);
                ds = new DataSet();
                dest.Fill(ds);
                cmd.Dispose();
        ...
        public long get_capid(int m_ma, string m_yy)
        {
            ...
            cmd.CommandType = CommandType.Text;
            cmd.Parameters.Add("m_ma", OracleDbType.Decimal).Value = m_ma;
            cmd.Parameters.Add("m_yy", OracleDbType.Varchar2).Value = m_yy;
            int irec = cmd.ExecuteNonQuery();
            cmd.Dispose();
            if (irec == 0)
            {
        ...
        private long get_capid_may(int m_ma, string m_computer)
        {
            ...
            cmd.CommandType = CommandType.Text;
            cmd.Parameters.Add("m_ma", OracleDbType.Decimal).Value = m_ma;
            cmd.Parameters.Add("m_computer", OracleDbType.Varchar2, 20).Value = m_computer;
            int irec = cmd.ExecuteNonQuery();
            cmd.Dispose();
            if (irec == 0)
            {
                ...
                cmd.CommandType = CommandType.Text;
                cmd.Parameters.Add("m_ma", OracleDbType.Decimal).Value = m_ma;
                cmd.Parameters.Add("m_ten", OracleDbType.Varchar2, 20).Value = m_computer;
                cmd.Parameters.Add("m_computer", OracleDbType.Varchar2, 20).Value = m_computer;
                cmd.ExecuteNonQuery();
                cmd.Dispose();
            }
        ...
        {
            return true;//get_data("select * from " + user + ".tables where mmyy='" + mmyy + "'").Tables[0].Rows.Count > 0;
        }
        ...
        public string ngayhienhanh_server
        {
            get
            {
                return get_data("select to_char(sysdate,'dd/mm/yyyy hh24:mi') from dual").Tables[0].Rows[0][0].ToString();
            }
        }
        ...
        public string Mabv
        {
            get
            {
                try
                {
                    return get_data("select ten from " + user + ".thongso where id=2").Tables[0].Rows[0]["Ten"].ToString();
                }
                catch
                {
        ...
        public bool upd_thongso(int d_nhom, int d_id, string d_loai, string d_ten)
        {
            ...
            try
            {
                ...
                cmd = new OracleCommand(sql, con);
                cmd.CommandType = CommandType.Text;
                cmd.Parameters.Add("d_loai", OracleDbType.NVarchar2).Value = d_loai;
                cmd.Parameters.Add("d_ten", OracleDbType.NVarchar2).Value = d_ten;
                cmd.Parameters.Add("d_nhom", OracleDbType.Decimal).Value = d_nhom;
                cmd.Parameters.Add("d_id", OracleDbType.Decimal).Value = d_id;
                int irec = cmd.ExecuteNonQuery();
                cmd.Dispose();
                if (irec == 0)
                {
        ...
        public bool upd_bc_bv_Right(string id, string id_menu, string id_cha, decimal stt, string ten)
        {
            ...
            try
            {
                try
                {
                    ...
                    cmd = new OracleCommand(sql, con);
                    cmd.CommandType = CommandType.Text;                    
                    cmd.Parameters.Add("id_menu", OracleDbType.Varchar2).Value = id_menu;
                    cmd.Parameters.Add("id_cha", OracleDbType.Varchar2).Value = id_cha;
                    cmd.Parameters.Add("stt", OracleDbType.Decimal).Value = stt;
                    cmd.Parameters.Add("ten", OracleDbType.NVarchar2).Value = ten;
        ...
        public void upd_error(string m_message, string m_computer, string m_table)
        {
            ...
            try
            {
                ...
                cmd = new OracleCommand(sql, con);
                cmd.CommandType = CommandType.Text;
                cmd.Parameters.Add("m_message", OracleDbType.NVarchar2).Value = m_message;
                cmd.Parameters.Add("m_computer", OracleDbType.Varchar2, 20).Value = m_computer;
                cmd.Parameters.Add("m_table", OracleDbType.Varchar2, 20).Value = m_table;
                cmd.ExecuteNonQuery();
            }
            catch { }
            finally
        ...
        public void upd_bv_ktcao(string m_id,string m_maql,string m_mabn,string m_cpktcao,string m_mavaovien, string m_ngay,string m_makp,string m_userid,string m_computer)
        {
            if (con != null)
            {
                con.Close(); con.Dispose();
            }
            sql = "insert into medibv115.bv_ktcao(id,maql,mabn,cp_ktcao,mavaovien,ngay,makp,userid,ngayud,computer) " ;
            sql+=" values (:m_id,:m_maql,:m_mabn,:m_cpktcao,:m_mavaovien,:m_ngay,:m_makp,:m_userid,sysdate,:m_computer)";
            con = new OracleConnection(sConn);
            try
            {
                con.Open();
                cmd = new OracleCommand(sql, con);
                cmd.CommandType = CommandType.Text;
                cmd.Parameters.Add("m_id", OracleDbType.NVarchar2).Value = m_id;
                cmd.Parameters.Add("m_maql", OracleDbType.Decimal).Value = m_maql;
                cmd.Parameters.Add("m_mabn", OracleDbType.NVarchar2).Value = m_mabn;
                cmd.Parameters.Add("m_m_cpktcao", OracleDbType.Decimal).Value = m_cpktcao;
                cmd.Parameters.Add("m_mavaovien", OracleDbType.Decimal).Value = m_mavaovien;
                cmd.Parameters.Add("m_ngay", OracleDbType.Date).Value = m_ngay;
                cmd.Parameters.Add("m_makp", OracleDbType.NVarchar2).Value = m_makp;
                cmd.Parameters.Add("m_userid", OracleDbType.NVarchar2).Value = m_userid;
                cmd.Parameters.Add("m_computer", OracleDbType.Varchar2, 20).Value = m_computer;
        ...
        public bool upd_bc_dmbv(string d_mabv, decimal d_stt, string d_tenbv, string d_ten_menu, string d_id_menu)
        {
            ...
            try
            {
                ...
                cmd = new OracleCommand(sql, con);
                cmd.CommandType = CommandType.Text;
                cmd.Parameters.Add("d_tenbv", OracleDbType.NVarchar2).Value = d_tenbv;
                cmd.Parameters.Add("d_ten_menu", OracleDbType.NVarchar2).Value = d_ten_menu;
                cmd.Parameters.Add("d_id_menu", OracleDbType.Varchar2, 4).Value = d_id_menu;
                cmd.Parameters.Add("d_mabv", OracleDbType.Varchar2, 10).Value = d_mabv;
                cmd.Parameters.Add("d_stt", OracleDbType.Decimal).Value = d_stt;                                                
                int irec = cmd.ExecuteNonQuery();
                cmd.Dispose();
                if (irec == 0)
                {
        ...
        public bool upd_bc_dlogin_right(long d_id, string d_right_)
        {
            ...
            try
            {
                ...
                cmd = new OracleCommand(sql, con);
                cmd.CommandType = CommandType.Text;
                cmd.Parameters.Add("d_right_", OracleDbType.NVarchar2).Value = d_right_;
                cmd.Parameters.Add("d_id", OracleDbType.Decimal).Value = d_id;
                cmd.ExecuteNonQuery();
            }
            catch (OracleException ex)
        ...
        public bool upd_v_nhomkhoabv1ct(int d_id, string d_mavp, string d_tenvp)
        {
            ...
            try
            {
                ...
                cmd = new OracleCommand(sql, con);
                cmd.CommandType = CommandType.Text;                
                cmd.Parameters.Add("d_tenvp", OracleDbType.NVarchar2).Value = d_tenvp;
                cmd.Parameters.Add("d_id", OracleDbType.Decimal).Value = d_id;
                cmd.Parameters.Add("d_mavp", OracleDbType.Varchar2, 10).Value = d_mavp;
                int irec = cmd.ExecuteNonQuery();
                cmd.Dispose();
                if (irec == 0)
                {
            ...
            {
                upd_error(ex.Message, sComputer, "v_nhomkhoabv1ct");
                return false;
            }
            finally
            {
        ...
        public bool Delete_v_nhomkhoabv1ct(int d_id, string d_mavp)
        {
            sql = " delete from " + user + ".v_nhomkhoabv1ct where id='" + d_id + "'and mavp not in(" + d_mavp + ")";
            con = new OracleConnection(sConn);
            try
            {
               // execute_data(sql);
        ...
        public bool upd_bc_dlogin(long d_id, string d_hoten, string d_userid, string d_password_, string d_right_, int d_nhomkho, string d_makho, string d_makp, int d_tao, int d_admin, string d_manhom, string d_loaint, string d_loaikhac, string d_loaivp, string d_loaicdha)
        {
            ...
            try
            {
                ...
                cmd = new OracleCommand(sql, con);
                cmd.CommandType = CommandType.Text;
                cmd.Parameters.Add("d_hoten", OracleDbType.NVarchar2).Value = d_hoten;
                cmd.Parameters.Add("d_userid", OracleDbType.Varchar2, 20).Value = d_userid;
                cmd.Parameters.Add("d_password_", OracleDbType.Varchar2, 20).Value = d_password_;
                cmd.Parameters.Add("d_right_", OracleDbType.NVarchar2).Value = d_right_;
                cmd.Parameters.Add("d_nhomkho", OracleDbType.Decimal).Value = d_nhomkho;
                cmd.Parameters.Add("d_makho", OracleDbType.NVarchar2).Value = d_makho;
                cmd.Parameters.Add("d_makp", OracleDbType.NVarchar2).Value = d_makp;
                cmd.Parameters.Add("d_tao", OracleDbType.Decimal).Value = d_tao;
                cmd.Parameters.Add("d_admin", OracleDbType.Decimal).Value = d_admin;
                cmd.Parameters.Add("d_manhom", OracleDbType.NVarchar2).Value = d_manhom;
                cmd.Parameters.Add("d_loaint", OracleDbType.NVarchar2).Value = d_loaint;
                cmd.Parameters.Add("d_loaikhac", OracleDbType.NVarchar2).Value = d_loaikhac;
                cmd.Parameters.Add("d_loaivp", OracleDbType.NVarchar2).Value = d_loaivp;
                cmd.Parameters.Add("d_loaicdha", OracleDbType.NVarchar2).Value = d_loaicdha;
                cmd.Parameters.Add("d_id", OracleDbType.Decimal).Value = d_id;
        ...
        public void updrec(DataTable dt, long id, string userid, string password, string right, int nhomkho, string makho, string makp, string loaivp, string loaicdha, string makp_med)
        {
            string exp = "id=" + id;
            DataRow r = getrowbyid(dt, exp);
            if (r == null)
        ...
        public bool upd_bc_Nhomkp(long v_id, decimal v_stt, string v_ten, string v_makp)
        {
            ...
            cmd.Parameters.Add("v_stt", OracleDbType.Decimal).Value = v_stt;
            cmd.Parameters.Add("v_ten", OracleDbType.Varchar2, 100).Value = v_ten;
            cmd.Parameters.Add("v_makp", OracleDbType.Varchar2, 100).Value = v_makp;
            cmd.Parameters.Add("v_id", OracleDbType.Decimal).Value = v_id;
        ...
        public bool upd_bc_Nhomkho(long v_id, decimal v_stt, string v_ten, string v_makho)
        {
            sql = "update " + user + ".bc_nhomkho set stt=:v_stt,ten=:v_ten,makho=:v_makho where id=:v_id";
            con = new OracleConnection(sConn);
            cmd = new OracleCommand(sql, con);
            cmd.CommandType = CommandType.Text;
            ...
            cmd.Parameters.Add("v_stt", OracleDbType.Decimal).Value = v_stt;
            cmd.Parameters.Add("v_ten", OracleDbType.Varchar2, 100).Value = v_ten;
            cmd.Parameters.Add("v_makho", OracleDbType.Varchar2, 100).Value = v_makho;
            cmd.Parameters.Add("v_id", OracleDbType.Decimal).Value = v_id;
            ...
            try
            {
                ...
                if (irec == 0)
                {
                    sql = "insert into " + user + ".bc_nhomkho(id,stt,ten,makho) values(:v_id,:v_stt,:v_ten,:v_makho)";
                    cmd = new OracleCommand(sql, con);
                    cmd.CommandType = CommandType.Text;
            ...
            {
                upd_error(ex.Message, sComputer, "bc_nhomkho");
                return false;
            }
            finally
            {
        ...
        public bool upd_maubaocao(long v_id, string v_ma, string v_ten, string v_loai)
        {
            ...
            cmd.Parameters.Add("v_ma", OracleDbType.Varchar2, 50).Value = v_ma;
            cmd.Parameters.Add("v_ten", OracleDbType.Varchar2, 254).Value = v_ten;
            cmd.Parameters.Add("v_loai", OracleDbType.Varchar2, 100).Value = v_loai;
            cmd.Parameters.Add("v_id", OracleDbType.Decimal).Value = v_id;
            try
            {
                con.Open();
        ...
        public bool upd_dmkhac(long v_id, string v_id_khac)
        {
            ...
            cmd.Parameters.Add("v_id_khac", OracleDbType.Varchar2, 100).Value = v_id_khac;
            cmd.Parameters.Add("v_id", OracleDbType.Decimal).Value = v_id;
        ...
        public bool upd_loainhanvien(long v_id, decimal v_stt, string v_ten, string v_mabs)
        {
            ...
            cmd.Parameters.Add("v_stt", OracleDbType.Decimal).Value = v_stt;
            cmd.Parameters.Add("v_ten", OracleDbType.Varchar2, 100).Value = v_ten;
            cmd.Parameters.Add("v_mabs", OracleDbType.Varchar2, 2000).Value = v_mabs;
            cmd.Parameters.Add("v_id", OracleDbType.Decimal).Value = v_id;
        ...
        public bool upd_bc_Nhomdoituong(long v_id, decimal v_stt, string v_ten, string v_madoituong)
        {
            ...
            cmd.Parameters.Add("v_stt", OracleDbType.Decimal).Value = v_stt;
            cmd.Parameters.Add("v_ten", OracleDbType.Varchar2, 100).Value = v_ten;
            cmd.Parameters.Add("v_madoituong", OracleDbType.Varchar2, 100).Value = v_madoituong;
            cmd.Parameters.Add("v_id", OracleDbType.Decimal).Value = v_id;
        ...
        public bool upd_dutrukho(int d_manguon, int d_makho, string d_mmyy, int d_mabd, decimal d_dau, decimal d_nhap, decimal d_xuat, decimal d_ton, decimal d_tutruc, decimal d_tc, decimal d_dongia, decimal d_l1, decimal d_d1, decimal d_l2, decimal d_d2, string d_nhacc, string d_donvi)
        {
            ...
            sql = "update " + user + ".d_dutrukho set dau=:d_dau, nhap=:d_nhap,xuat=:d_xuat,ton=:d_ton,tutruc=:d_tutruc,tc=:d_tc,l1=:d_l1,d1=:d_d1,l2=:d_l2,d2=:d_d2,nhacc=:d_nhacc,donvi=:d_donvi,manguon=:d_manguon where makho=:d_makho and mmyy=:d_mmyy and mabd=:d_mabd and dongia=:d_dongia";
            con = new OracleConnection(sConn);
            try
            {
                con.Open();
                cmd = new OracleCommand(sql, con);
                cmd.CommandType = CommandType.Text;
                cmd.Parameters.Add("d_dau", OracleDbType.Decimal).Value = d_dau;
                cmd.Parameters.Add("d_nhap", OracleDbType.Decimal).Value = d_nhap;
                cmd.Parameters.Add("d_xuat", OracleDbType.Decimal).Value = d_xuat;
                cmd.Parameters.Add("d_ton", OracleDbType.Decimal).Value = d_ton;
                cmd.Parameters.Add("d_tutruc", OracleDbType.Decimal).Value = d_tutruc;
                cmd.Parameters.Add("d_tc", OracleDbType.Decimal).Value = d_tc;
                cmd.Parameters.Add("d_l1", OracleDbType.Decimal).Value = d_l1;
                cmd.Parameters.Add("d_d1", OracleDbType.Decimal).Value = d_d1;
                cmd.Parameters.Add("d_l2", OracleDbType.Decimal).Value = d_l2;
                cmd.Parameters.Add("d_d2", OracleDbType.Decimal).Value = d_d2;
                cmd.Parameters.Add("d_nhacc", OracleDbType.NVarchar2).Value = d_nhacc;
                cmd.Parameters.Add("d_donvi", OracleDbType.NVarchar2).Value = d_donvi;
                cmd.Parameters.Add("d_manguon", OracleDbType.Decimal).Value = d_manguon;

                cmd.Parameters.Add("d_makho", OracleDbType.Decimal).Value = d_makho;
                cmd.Parameters.Add("d_mmyy", OracleDbType.Varchar2, 4).Value = d_mmyy;
                cmd.Parameters.Add("d_mabd", OracleDbType.Decimal).Value = d_mabd;                
                cmd.Parameters.Add("d_dongia", OracleDbType.Decimal).Value = d_dongia;
                
                int i = cmd.ExecuteNonQuery();
                cmd.Dispose();
                if (i == 0)
                {
                    sql = " insert into " + user + ".d_dutrukho(makho,mmyy,mabd,dau,nhap,xuat,ton,tutruc,tc,l1,d1,l2,d2,nhacc,donvi,manguon,dongia) ";
                    sql+=" values (:d_makho,:d_mmyy,:d_mabd,:d_dau,:d_nhap,:d_xuat,:d_ton,:d_tutruc,:d_tc,:d_l1,:d_d1,:d_l2,:d_d2,:d_nhacc,:d_donvi,:d_manguon,:d_dongia)";
                    //con.Open();
                    cmd = new OracleCommand(sql, con);
                    cmd.CommandType = CommandType.Text;
        ...
        public bool upd_bc_nhombd(long d_id, string d_ten, int d_id_nhom, int d_stt, int d_ycu)
        {
            ...
            try
            {
                ...
                cmd.Parameters.Add("d_ten", OracleDbType.NVarchar2).Value = d_ten;                
                cmd.Parameters.Add("d_stt", OracleDbType.Decimal).Value = d_stt;                
                cmd.Parameters.Add("d_ycu", OracleDbType.Decimal).Value = d_ycu;
                cmd.Parameters.Add("d_id", OracleDbType.Decimal).Value = d_id;
                cmd.Parameters.Add("d_id_nhom", OracleDbType.Decimal).Value = d_id_nhom;
                int irec = cmd.ExecuteNonQuery();
                cmd.Dispose();
                if (irec == 0)
                {
        ...
        public bool upd_bc_dmnhomnguon(long d_id, string d_ten, int d_id_nguon, int d_stt)
        {
            ...
            try
            {
                ...
                cmd.Parameters.Add("d_stt", OracleDbType.Decimal).Value = d_stt;
                cmd.Parameters.Add("d_id", OracleDbType.Decimal).Value = d_id;
                cmd.Parameters.Add("d_id_nguon", OracleDbType.Decimal).Value = d_id_nguon;
        ...
        public void upd_bcbhyt(int l_id, int i_stt, string s_ten, int i_idnhomvp, string i_idloaivp)
        {
            ...
            int i = 0;
            sql_upd = "update " + user + ".dmbaocao_bhyt set stt=:i_stt,ten=:s_ten,idnhomvp=:i_idnhomvp,idloaivp=:i_idloaivp where id=:l_id";
            sql_int = "insert into " + user + ".dmbaocao_bhyt(id,stt,ten,idnhomvp,idloaivp) values(:l_id,:i_stt,:s_ten,:i_idnhomvp,:i_idloaivp)";
            OracleConnection con = new OracleConnection(sConn);
            con.Open();
            OracleCommand cmd = new OracleCommand(sql_upd, con);
            cmd.CommandType = CommandType.Text;
            
            cmd.Parameters.Add("i_stt", OracleDbType.Decimal, 3).Value = i_stt;
            cmd.Parameters.Add("s_ten", OracleDbType.NVarchar2, 100).Value = s_ten;
            cmd.Parameters.Add("i_idnhomvp", OracleDbType.Decimal, 7).Value = i_idnhomvp;
            cmd.Parameters.Add("i_idloaivp", OracleDbType.Varchar2, 80).Value = i_idloaivp;
            cmd.Parameters.Add("l_id", OracleDbType.Decimal, 3).Value = l_id;
            i = cmd.ExecuteNonQuery();
            if (i == 0)
            {
                cmd.Dispose();
                cmd = new OracleCommand(sql_int, con);
                cmd.Parameters.Add("l_id", OracleDbType.Decimal, 3).Value = l_id;
                cmd.Parameters.Add("i_stt", OracleDbType.Decimal, 3).Value = i_stt;
                cmd.Parameters.Add("s_ten", OracleDbType.NVarchar2, 100).Value = s_ten;
                cmd.Parameters.Add("i_idnhomvp", OracleDbType.Decimal, 7).Value = i_idnhomvp;
        ...
        public bool upd_phieuxuat(string d_mmyy, long d_id, string d_ngay, int d_makp, int d_nhom, string d_loai, string d_phieu, string d_kho, decimal d_sotien, int d_userid)
        {
            ...
            try
            {
                ...
                cmd.Parameters.Add("d_id", OracleDbType.Decimal).Value = d_id;
                cmd.Parameters.Add("d_ngay", OracleDbType.Varchar2, 10).Value = d_ngay;
                cmd.Parameters.Add("d_makp", OracleDbType.Decimal).Value = d_makp;
                cmd.Parameters.Add("d_nhom", OracleDbType.Decimal).Value = d_nhom;
                cmd.Parameters.Add("d_loai", OracleDbType.Varchar2, 10).Value = d_loai;
                cmd.Parameters.Add("d_phieu", OracleDbType.Varchar2, 20).Value = d_phieu;
                cmd.Parameters.Add("d_kho", OracleDbType.Varchar2, 20).Value = d_kho;
                cmd.Parameters.Add("d_sotien", OracleDbType.Decimal).Value = d_sotien;
                cmd.Parameters.Add("d_userid", OracleDbType.Decimal).Value = d_userid;
                cmd.ExecuteNonQuery();
            }
            catch (OracleException ex)
            {
        ...
        public bool upd_phieuxuat(string d_mmyy, long d_id, string d_soct, string d_ngay, int d_makp, int d_nhom, string d_loai, string d_phieu, string d_kho, decimal d_sotien, string d_no, string d_co, string d_diengiai, int d_userid)
        {
            ...
            try
            {
                ...
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add("d_id", OracleDbType.Decimal).Value = d_id;
                cmd.Parameters.Add("d_soct", OracleDbType.Varchar2, 10).Value = d_soct;
                cmd.Parameters.Add("d_ngay", OracleDbType.Varchar2, 10).Value = d_ngay;
                cmd.Parameters.Add("d_makp", OracleDbType.Decimal).Value = d_makp;
                cmd.Parameters.Add("d_nhom", OracleDbType.Decimal).Value = d_nhom;
                cmd.Parameters.Add("d_loai", OracleDbType.Varchar2, 10).Value = d_loai;
                ...
                cmd.Parameters.Add("d_kho", OracleDbType.Varchar2, 20).Value = d_kho;
                cmd.Parameters.Add("d_sotien", OracleDbType.Decimal).Value = d_sotien;
                cmd.Parameters.Add("d_no", OracleDbType.Varchar2, 20).Value = d_no;
                cmd.Parameters.Add("d_co", OracleDbType.Varchar2, 20).Value = d_co;
                cmd.Parameters.Add("d_diengiai", OracleDbType.NVarchar2).Value = d_diengiai;
                cmd.Parameters.Add("d_userid", OracleDbType.Decimal).Value = d_userid;
                cmd.ExecuteNonQuery();
            }
            catch (OracleException ex)
        ...
        public bool upd_bieu07(long m_id, int m_ma, string m_ngay, Decimal m_soluong, int m_userid)
        {
            ...
            try
            {
                ...
                cmd = new OracleCommand(sql, con);
                cmd.CommandType = CommandType.Text;
                cmd.Parameters.Add("m_ngay", OracleDbType.Date).Value = StringToDateTime(m_ngay);
                cmd.Parameters.Add("m_soluong", OracleDbType.Decimal).Value = m_soluong;
                cmd.Parameters.Add("m_userid", OracleDbType.Decimal).Value = m_userid;
                cmd.Parameters.Add("m_id", OracleDbType.Decimal).Value = m_id;
                cmd.Parameters.Add("m_ma", OracleDbType.Decimal).Value = m_ma;
                int irec = cmd.ExecuteNonQuery();
                cmd.Dispose();
                if (irec == 0)
        ...
        public bool upd_danhmuc(string d_table, long d_id, string d_ma, string d_ten, int d_nhom, int d_stt)
        {
            ...
            try
            {
                ...
                cmd = new OracleCommand(sql, con);
                cmd.CommandType = CommandType.Text;
                cmd.Parameters.Add("d_ma", OracleDbType.NVarchar2).Value = d_ma;
                cmd.Parameters.Add("d_ten", OracleDbType.NVarchar2).Value = d_ten;
                cmd.Parameters.Add("d_nhom", OracleDbType.Decimal).Value = d_nhom;
                cmd.Parameters.Add("d_stt", OracleDbType.Decimal).Value = d_stt;
                cmd.Parameters.Add("d_id", OracleDbType.Decimal).Value = d_id;
        ...
        public bool upd_tonkhoth(string mmyy, int makho, int manguon, int mabd, decimal soluong, string fie)
        {
            ...
            try
            {
                ...
                cmd = new OracleCommand(sql, con);
                cmd.CommandType = CommandType.Text;
                cmd.Parameters.Add("soluong", OracleDbType.Decimal).Value = soluong;
                cmd.Parameters.Add("makho", OracleDbType.Decimal).Value = makho;
                cmd.Parameters.Add("manguon", OracleDbType.Decimal).Value = manguon;
                cmd.Parameters.Add("mabd", OracleDbType.Decimal).Value = mabd;
                int irec = cmd.ExecuteNonQuery();
                cmd.Dispose();
                if (irec == 0)
                {
        ...
        public bool upd_tonkhoct(string d_mmyy, int d_makho, long d_stt, int d_mabd, decimal d_tondau)
        {
            ...
            try
            {
                ...
                cmd.Parameters.Add("d_stt", OracleDbType.Decimal).Value = d_stt;
                cmd.Parameters.Add("d_mabd", OracleDbType.Decimal).Value = d_mabd;
                cmd.Parameters.Add("d_tondau", OracleDbType.Decimal).Value = d_tondau;
                cmd.ExecuteNonQuery();
            }
            catch (OracleException ex)
            {
            ...
            int m_c17, int m_c18, int m_c19, int m_c20, int m_userid)
        {
            ...
            try
            {
                ...
                cmd.CommandType = CommandType.Text;
                cmd.Parameters.Add("m_ngay", OracleDbType.Date).Value = StringToDateTime(m_ngay);
                cmd.Parameters.Add("m_c01", OracleDbType.Decimal).Value = m_c01;
                cmd.Parameters.Add("m_c02", OracleDbType.Decimal).Value = m_c02;
                cmd.Parameters.Add("m_c03", OracleDbType.Decimal).Value = m_c03;
                cmd.Parameters.Add("m_c04", OracleDbType.Decimal).Value = m_c04;
                cmd.Parameters.Add("m_c05", OracleDbType.Decimal).Value = m_c05;
                cmd.Parameters.Add("m_c06", OracleDbType.Decimal).Value = m_c06;
                cmd.Parameters.Add("m_c07", OracleDbType.Decimal).Value = m_c07;
                cmd.Parameters.Add("m_c08", OracleDbType.Decimal).Value = m_c08;
                cmd.Parameters.Add("m_c09", OracleDbType.Decimal).Value = m_c09;
                cmd.Parameters.Add("m_c10", OracleDbType.Decimal).Value = m_c10;
                cmd.Parameters.Add("m_c11", OracleDbType.Decimal).Value = m_c11;
                cmd.Parameters.Add("m_c12", OracleDbType.Decimal).Value = m_c12;
                cmd.Parameters.Add("m_c13", OracleDbType.Decimal).Value = m_c13;
                cmd.Parameters.Add("m_c14", OracleDbType.Decimal).Value = m_c14;
                cmd.Parameters.Add("m_c15", OracleDbType.Decimal).Value = m_c15;
                cmd.Parameters.Add("m_c16", OracleDbType.Decimal).Value = m_c16;
                cmd.Parameters.Add("m_c17", OracleDbType.Decimal).Value = m_c17;
                cmd.Parameters.Add("m_c18", OracleDbType.Decimal).Value = m_c18;
                cmd.Parameters.Add("m_c19", OracleDbType.Decimal).Value = m_c19;
                cmd.Parameters.Add("m_c20", OracleDbType.Decimal).Value = m_c20;
                cmd.Parameters.Add("m_userid", OracleDbType.Decimal).Value = m_userid;
                cmd.Parameters.Add("m_id", OracleDbType.Decimal).Value = m_id;
                cmd.Parameters.Add("m_ma", OracleDbType.Decimal).Value = m_ma;
                int irec = cmd.ExecuteNonQuery();
        ...
        public bool upd_bc_theonhomicd(string s_ma, string s_ten, int i_idnhom,int i_stt)
        {
            ...
            try
            {
                ...
                cmd = new OracleCommand(sql, con);
                cmd.CommandType = CommandType.Text;
                cmd.Parameters.Add("s_ma", OracleDbType.Varchar2,9).Value = s_ma;
                cmd.Parameters.Add("s_ten", OracleDbType.NVarchar2).Value = s_ten;
                cmd.Parameters.Add("i_idnhom", OracleDbType.Decimal).Value = i_idnhom;
                cmd.Parameters.Add("i_stt", OracleDbType.Decimal).Value = i_stt;
                int irec = cmd.ExecuteNonQuery();
                cmd.Dispose();
                if (irec == 0)
                {
        ...
        public void upd_v_nhomkhoabvct(int d_id, string d_makp, string d_tenkp)
        {
            ...
            try
            {
                ...
                cmd = new OracleCommand(sql, con);
                cmd.CommandType = CommandType.Text;
                cmd.Parameters.Add("d_tenkp", OracleDbType.NVarchar2).Value = d_tenkp;
                cmd.Parameters.Add("d_id", OracleDbType.Decimal).Value = d_id;
                cmd.Parameters.Add("d_makp", OracleDbType.Varchar2, 3).Value = d_makp;
        ...
        public bool upd_bc_nhomkp(long d_id, long d_stt, string d_ma, string d_ten, string d_makp)
        {
            sql = " update " + user + ".bc_nhomkp set stt=:d_stt,ma=:d_ma,ten=:d_ten where id=:d_id and makp=:d_makp";
            con = new OracleConnection(sConn);
            try
            {
                con.Open();
                ...
                cmd.CommandType = CommandType.Text;
                cmd.Parameters.Add("d_stt", OracleDbType.Decimal).Value = d_stt;
                cmd.Parameters.Add("d_ma", OracleDbType.Varchar2).Value = d_ma;
                cmd.Parameters.Add("d_ten", OracleDbType.NVarchar2).Value = d_ten;
                cmd.Parameters.Add("d_id", OracleDbType.Decimal).Value = d_id;
                cmd.Parameters.Add("d_makp", OracleDbType.Varchar2, 3).Value = d_makp;
                ...
                if (irec == 0)
                {
                    sql = "insert into " + user + ".bc_nhomkp(stt,ma,ten,id,makp) values (:d_stt,:d_ma,:d_ten,:d_id,:d_makp)";
                    cmd = new OracleCommand(sql, con);
                    cmd.CommandType = CommandType.Text;
                    cmd.Parameters.Add("d_stt", OracleDbType.Decimal).Value = d_stt;
                    cmd.Parameters.Add("d_ma", OracleDbType.Varchar2).Value = d_ma;
        ...
        public bool upd_ICD10(string s_stt, string s_icd10)
        {
            sql = "update " + user + ".ICD10 set stt=:s_stt where substring(cicd10,0,4)=substring(:s_icd10,0,4) ";
            con = new OracleConnection(sConn);
            try
            {
                con.Open();
                cmd = new OracleCommand(sql, con);
                cmd.CommandType = CommandType.Text;
                cmd.Parameters.Add("s_stt", OracleDbType.NVarchar2).Value = s_stt;
                cmd.Parameters.Add("s_icd10", OracleDbType.NVarchar2).Value = s_icd10;
                int irec = cmd.ExecuteNonQuery();
                cmd.Dispose();
            }
            catch (OracleException ex)
            {
                upd_error(ex.Message, sComputer, "ICD-10");
                return false;
            }
            finally
            {
        ...
        public bool upd_v_nhomkhoabv1ll(int d_id, string d_ma, string d_ten, int d_stt, string d_mavp)
        {
            sql = " update " + user + ".v_nhomkhoabv1ll set ma=:d_ma,ten=:d_ten,stt=:d_stt,mavp=:d_mavp where id=:d_id";
            con = new OracleConnection(sConn);
            try
            {
                con.Open();
                ...
                cmd.Parameters.Add("d_ten", OracleDbType.NVarchar2).Value = d_ten;
                cmd.Parameters.Add("d_stt", OracleDbType.Decimal).Value = d_stt;
                cmd.Parameters.Add("d_mavp", OracleDbType.NVarchar2).Value = d_mavp;
                int irec = cmd.ExecuteNonQuery();
                cmd.Dispose();
                if (irec == 0)
                {
                    sql = "insert into " + user + ".v_nhomkhoabv1ll(id,ma,ten,stt,mavp) values (:d_id,:d_ma,:d_ten,:d_stt,:d_mavp)";
                    cmd = new OracleCommand(sql, con);
                    cmd.CommandType = CommandType.Text;
                    cmd.Parameters.Add("d_id", OracleDbType.Decimal).Value = d_id;
                    cmd.Parameters.Add("d_ma", OracleDbType.NVarchar2).Value = d_ma;
            ...
            {
                upd_error(ex.Message, sComputer, "v_nhomkhoabv1ll");
                return false;
            }
            finally
            {
        ...
        public string get_mapt(string tenpt)
        {
            ...
            try
            {
                ...
                cmd = new OracleCommand(sql, con);
                cmd.CommandType = CommandType.Text;
                cmd.Parameters.Add("tenpt", OracleDbType.NVarchar2).Value = tenpt.Trim();
                dest = new OracleDataAdapter(cmd);
                ds = new DataSet();
                dest.Fill(ds);
                cmd.Dispose();
                    ...
                    for (int j = itu; j <= iden; j++)
                    {
                        ...
                        if (bMmyy(mmyy))
                        {
                           ...
                           // asql = asql.Replace("medibvmmyy.", user + mmyy + ".");
                            //asql = asql.Replace("medibv.", mmyy + ".");
                            asql = str.Replace("xxxxx", "medibv115" + mmyy );
                            if (be)
                            {
                                tmp = get_data(asql);
                                be = false;
                            }
                            else tmp.Merge(get_data(asql));
                        }
                    }
                }
            }
        ...
        public DataSet get_data_mmyy_for(string str, string tu, string den, bool khoangcach)
        {           
            DataSet tmp = new DataSet();
            try
            {
                DateTime dt1 = StringToDate(tu).AddMonths(-1);//(khoangcach) ? StringToDate(tu).AddDays(-iNgaykiemke) : StringToDate(tu);
                DateTime dt2 = StringToDate(tu).AddMonths(1);//(khoangcach) ? StringToDate(den).AddDays(iNgaykiemke) : StringToDate(den);
                int y1 = dt1.Year, m1 = dt1.Month;
                int y2 = dt2.Year, m2 = dt2.Month;
                int itu, iden;
                string mmyy = "", asql="";
        ...
        public bool upd_pttt(string s_mmyy, long m_id, string m_ptv, string m_phu1, string m_phu2, string m_bsgayme, string m_ktvgayme,string m_hoisuc, string m_dungcu)
        {
            ...
            try
            {
                ...
                cmd.CommandType = CommandType.Text;
                cmd.Parameters.Add("m_id", OracleDbType.Decimal).Value = m_id;
                cmd.Parameters.Add("m_ptv", OracleDbType.Varchar2, 4).Value = m_ptv;
                cmd.Parameters.Add("m_phu1", OracleDbType.Varchar2, 4).Value = m_phu1;
                cmd.Parameters.Add("m_phu2", OracleDbType.Varchar2, 4).Value = m_phu2;
                cmd.Parameters.Add("m_bsgayme", OracleDbType.Varchar2, 4).Value = m_bsgayme;
                cmd.Parameters.Add("m_ktvgayme", OracleDbType.Varchar2, 4).Value = m_ktvgayme;
                cmd.Parameters.Add("m_hoisuc", OracleDbType.Varchar2, 4).Value = m_hoisuc;
                cmd.Parameters.Add("m_dungcu", OracleDbType.Varchar2, 4).Value = m_dungcu;
                int irec = cmd.ExecuteNonQuery();
                cmd.Dispose();
                if (irec == 0)
                {
        ...
        public bool upd_pttt_bsduyetmo(long m_id, int m_loai, string m_mabs)
        {
            ...
            try
            {
                ...
                cmd.Parameters.Add("m_id", OracleDbType.Decimal).Value = m_id;                
                cmd.Parameters.Add("m_mabs", OracleDbType.Varchar2).Value = m_mabs;
      ...
      decimal b_phu2, decimal b_bsgayme, decimal b_ktvgayme, decimal b_hoisuc, decimal b_dungcu)
        {
            ...
            sql_int = "insert into " + user + ".boiduong_pttt(ptv,tenloai,phu1,phu2,bsgayme,ktvgayme,hoisuc,dungcu,pttt,loai) " +
                " values(" + b_ptv + ",:b_tenloai," + b_phu1 + "," + b_phu2 + "," + b_bsgayme + "," + b_ktvgayme + "," + b_hoisuc + "," + b_dungcu + ",'" + b_pttt + "','" + b_loai + "')";
            OracleConnection con = new OracleConnection(sConn);
            con.Open();
            OracleCommand cmd = new OracleCommand(sql_upd, con);
            cmd.CommandType = CommandType.Text;
            
            cmd.Parameters.Add("b_ptv", OracleDbType.Decimal).Value = b_ptv;
            cmd.Parameters.Add("b_tenloai", OracleDbType.NVarchar2).Value = b_tenloai;
            cmd.Parameters.Add("b_phu1", OracleDbType.Decimal).Value = b_phu1;
            cmd.Parameters.Add("b_phu2", OracleDbType.Decimal).Value = b_phu2;
            cmd.Parameters.Add("b_bsgayme", OracleDbType.Decimal).Value = b_bsgayme;
            cmd.Parameters.Add("b_ktvgayme", OracleDbType.Decimal).Value = b_ktvgayme;
            cmd.Parameters.Add("b_hoisuc", OracleDbType.Decimal).Value = b_hoisuc;
            cmd.Parameters.Add("b_dungcu", OracleDbType.Decimal).Value = b_dungcu;
            cmd.Parameters.Add("b_pttt", OracleDbType.Varchar2, 1).Value = b_pttt;
            cmd.Parameters.Add("b_loai", OracleDbType.Varchar2, 10).Value = b_loai;
            i = cmd.ExecuteNonQuery();
            if (i == 0)
            {
                cmd.Dispose();
        ...
        public DataSet F_Get_Baocao(string tu, string den, string mabn, string hoten, string phai, string mann, string matt, string maquan, string maphuongxa, string madantoc, string makp, string mabsdt, string makt, string maktv, string userid, string tronggio, string loaibn, string giobaocao, string madoituong, string loaicdha, string dotuoi, string nhomkt, string bacsidoc)
        {
            ...
            try
            {
                ...
                sql += " left join " + user + ".bhyt bh1 on a.maql=bh1.maql";
                sql += " left join xxx.cdha_ctphimxq p1 on ct.id=p1.id and ct.makt=p1.makt";
                sql += " left join " + user + ".cdha_thuocphim tp on p1.loai=tp.loai and p1.idtp=tp.id_tp";
                sql += " where  ";
        ...
        public void execute_data(string sql, bool bLuu_err)
        {
            try
            {
                if (con != null)
            ...
            {
                if (bLuu_err) upd_error(ex.Message.ToString().Trim(), sComputer, "?");
            }
        }
        ...
        public int f_execute_data(string sql)
        {
            int roweffect = 0;
            try
            {
        ...
        {
            string s_user = user;
            execute_data("CREATE TABLE " + s_user + ".bc_dlogin(id number(5) NOT NULL,hoten nvarchar2(254),userid varchar2(20),password_ varchar2(20),right_ varchar2(4000),nhomkho number(2) DEFAULT (0),makho nvarchar2(254),makp nvarchar2(254),tao number(1) DEFAULT (0),admin number(1) DEFAULT (0),manhom nvarchar2(254),loaint nvarchar2(528),loaikhac nvarchar2(254),ngayud Date DEFAULT sysdate,thuhoi number(1) DEFAULT (0),loaivp nvarchar2(528),loaicdha nvarchar2(254),CONSTRAINT pk_bc_dlogin PRIMARY KEY (id))",false);
            execute_data("CREATE TABLE " + s_user + ".bc_dmbv(mabv varchar2(10) NOT NULL,stt number(3) NOT NULL,tenbv nvarchar2(528),ten_menu nvarchar2(528),id_menu varchar2(4),CONSTRAINT pk_bc_dmbv PRIMARY KEY (mabv, stt) )");

            execute_data("CREATE TABLE " + s_user + ".bc_thongso(mabv varchar2(10) NOT NULL,loai number(2)  DEFAULT (0),id_bc varchar2(50) ,stt number(3)  DEFAULT(0), ten nvarchar2(254),giatri number(1)  DEFAULT (0), diengiai varchar2(254),CONSTRAINT pk_bc_thongso PRIMARY KEY (mabv,loai,id_bc,stt))", false);

            execute_data("CREATE TABLE " + s_user + ".bc_maubaocao(id number(5)  DEFAULT (0),ma varchar2(50) ,ten varchar2(254), loai varchar2(100),CONSTRAINT pk_bc_maubaocao PRIMARY KEY (id))", false);

            execute_data("CREATE TABLE " + s_user + ".bc_dmkhac(id number(2)  DEFAULT (0),id_khac varchar2(200) ,CONSTRAINT pk_bc_dmkhac PRIMARY KEY (id))", false);
            execute_data("CREATE TABLE " + s_user + ".bc_nhomvp(manhom varchar2(128), tennhom varchar2(128) ,CONSTRAINT pk_bc_nhomvp PRIMARY KEY (manhom))", false);

            execute_data("CREATE TABLE " + s_user + ".bc_nhomkhoabvll(id number(3) NOT NULL, ma varchar2(10),ten nvarchar2(254),  stt number(3) DEFAULT (0),makp nvarchar2(528),ngayud Date DEFAULT sysdate, CONSTRAINT pk_v_nhomkhoabvll PRIMARY KEY (id))", false);
            execute_data("CREATE TABLE " + s_user + ".bc_nhomkhoabvct(id number(3) NOT NULL, makp varchar2(3),tenkp nvarchar2(254),CONSTRAINT pk_v_nhomkhoabvct PRIMARY KEY (id,makp)) ", false);
            execute_data("CREATE TABLE " + s_user + ".bc_loainhanvien(id number(2)  DEFAULT (0),stt number(2)  DEFAULT (0),ten varchar2(100),mabs varchar2(2000) ,CONSTRAINT pk_bc_loainhanvien PRIMARY KEY (id))", false);
            execute_data("CREATE TABLE " + s_user + ".bc_nhomdoituong(id number(2)  DEFAULT (0),stt number(2)  DEFAULT (0),ten varchar2(100),madoituong varchar2(254) ,CONSTRAINT pk_bc_nhomdoituong PRIMARY KEY (id) )", false);
            execute_data("CREATE TABLE " + s_user + ".bhyt_maubaocao (id number(10), maloai varchar2(64),tenloai nvarchar2(254), ten nvarchar2(254), filereport varchar2(64), used number(1) default (1), CONSTRAINT pk_bhyt_maubaocao PRIMARY KEY (id) )", false);
            execute_data("alter table " + s_user + ".bhyt_maubaocao add stt number(7)", false);
            execute_data("CREATE TABLE " + s_user + ".doituong_bhyt(ma_old varchar2(2), ma13 nvarchar2(254), ma_dt varchar2(2), ten_dt nvarchar2(254), ty_le number(3), ghichu nvarchar2(254), tien1 number(10), tien2 number(10), loai number(1), tenth varchar2(20), tonghop number(1), readonly number(1), stt number(3), viettat nvarchar2(254), stt_inth number(3) ) ", false);
            execute_data("CREATE TABLE " + s_user + ".dmnhomdv_bhyt(manhom number(3) NOT NULL, tennhom nvarchar2(254), mabv varchar2(8), tenbv nvarchar2(254), stt number(3) NOT NULL, CONSTRAINT pk_dmnhomdv_bhyt PRIMARY KEY (manhom, stt) ) ", false);
            execute_data("CREATE TABLE " + s_user + ".dmbaocao_bhyt (id number(3) NOT NULL, stt number(3), ten nvarchar2(254), idnhomvp number(3), idloaivp varchar2(80), CONSTRAINT pk_dmbaocao_bhyt PRIMARY KEY (id) )", false);
            execute_data("CREATE TABLE " + s_user + ".bhyt_thongso(id number(3) NOT NULL,loai nvarchar2(128),ten nvarchar2(254),nhom number(2) NOT NULL, ngayud Date DEFAULT sysdate,CONSTRAINT pk_bhyt_thongso PRIMARY KEY (id, nhom) )", false);
            execute_data("CREATE TABLE " + s_user + ".boiduong_pttt(  pttt nvarchar2(128) NOT NULL, loai varchar2(10) NOT NULL, tenloai nvarchar2(254), ptv number(10), phu1 number(10), phu2 number(10), bsgayme number(10), ktvgayme number(10), hoisuc number(10),  dungcu number(10), CONSTRAINT pk_boiduong_pttt PRIMARY KEY (pttt, loai)) ", false);
            execute_data("CREATE TABLE " + s_user + ".pttt_bs_duyetmo( id number(18) NOT NULL, loai number(2) DEFAULT (0), mabs varchar2(4) NOT NULL, CONSTRAINT pk_pttt_bs_duyetmo PRIMARY KEY (id, mabs));", false);
            execute_data("alter table " + s_user + ". pttt_bs_duyetmo alter column id type number(18);", false);
            execute_data("update " + s_user + ".boiduong_pttt set loai='1' where loai=0", false);
            execute_data(" CREATE TABLE " + s_user + mmyy + ".pttt_duyetmo(id number(18) NOT NULL, ptv varchar2(4), phu1 varchar2(4), phu2 varchar2(4), bsgayme varchar2(4), ktvgayme varchar2(4), hoisuc varchar2(4), dungcu varchar2(4), CONSTRAINT pk_pttt_duyetmo PRIMARY KEY (id) )", false);
            execute_data("alter table " + s_user + mmyy + ".pttt_duyetmo alter column id type number(18);", false);
            execute_data("alter table " + s_user + ".bhyt_maubaocao add loai  number(1) DEFAULT (0);", false);
            execute_data("alter table " + s_user + ".bhyt_maubaocao add tonghop number(2) DEFAULT (0);", false);
            execute_data("alter table " + s_user + ".bc_bv_right add soluong number(3) default 1;", false);
            execute_data("create table " + s_user + ".bhyt_theodoi (mabn varchar2(8), maql number(18), userid number(3), ngaynhanthe date, ngaytrathe date, ngayud date default sysdate, constraint pk_bhyt_theodoi primary key(mabn,maql))");
            execute_data("alter table " + s_user + ".bhyt_theodoi drop column ngayud");
            execute_data("alter table " + s_user + ".bhyt_theodoi add (muon number(1) default 0, ghichu nvarchar2(254), ngayud date default sysdate)");
            execute_data("alter table " + s_user + ".bc_dlogin add (makp_med nvarchar2(254))");
        }
        ...
        public int bGiabhyt
        {
            get
            {
                ds = get_data("select ten from " + user + ".bhyt_thongso where id=13 and nhom=0");
                if (ds.Tables[0].Rows.Count == 0) return 0;
                return int.Parse(ds.Tables[0].Rows[0][0].ToString());
            }
        }
        public string sManhomKTCao
        {
            get
            {
                ds = get_data("select ten from " + user + ".bhyt_thongso where id=14 and nhom=0");
                if (ds.Tables[0].Rows.Count == 0) return "0";
                return ds.Tables[0].Rows[0][0].ToString();
            }
        }
        ...
        {
            ds = get_data("select ten from " + user + ".d_thongso where id=83 and nhom=1");
            if (ds.Tables[0].Rows.Count == 0) return "50";
            return ds.Tables[0].Rows[0][0].ToString();
        }
        public int Ngay_toa_bhyt()
        {
            ds = get_data("select ten from " + user + ".d_thongso where id=99 and nhom=1");
            if (ds.Tables[0].Rows.Count > 0) return int.Parse(ds.Tables[0].Rows[0]["ten"].ToString());
            else return 1;
        }
        public string thetrongtinh_vitri_old
        {
            get
            {
                ds = get_data("select ten from " + user + ".bhyt_thongso where id=5 and nhom=0");
        ...
        {
            string ret = "0,2";
            ds = get_data("select ten from " + user + ".d_thongso where id=52 and nhom=1");
            if (ds.Tables[0].Rows.Count > 0)
            {
                ret = ds.Tables[0].Rows[0][0].ToString().Trim();
                int pos = ret.IndexOf(",");
        ...
        {
            string ret = "5,2";
            ds = get_data("select ten from " + user + ".d_thongso where id=53 and nhom=1");
            if (ds.Tables[0].Rows.Count > 0)
            {
                ret = ds.Tables[0].Rows[0][0].ToString().Trim();
                int pos = ret.IndexOf(",");
        ...
        {
            ds = get_data("select ten from " + user + ".d_thongso where id=82 and nhom=1");
            if (ds.Tables[0].Rows.Count == 0) return false;
            return ds.Tables[0].Rows[0][0].ToString() == "1";
        }
        public decimal themoi_chitra()
        {
            //			ds=get_data("select ten from " + user + ".d_thongso where id=49 and nhom=1");
            //			if (ds.Tables[0].Rows.Count==0) return 0;
            //			return decimal.Parse(ds.Tables[0].Rows[0][0].ToString());
            return 80;
        }
        public decimal themoi_chitra_95()
        {
            //			ds=get_data("select ten from " + user + ".d_thongso where id=49 and nhom=1");
            //			if (ds.Tables[0].Rows.Count==0) return 0;
            //			return decimal.Parse(ds.Tables[0].Rows[0][0].ToString());
        ...
        {
            ds = get_data("select ten from " + user + ".d_thongso where id=51 and nhom=1");
            if (ds.Tables[0].Rows.Count == 0) return 0;
            return decimal.Parse(ds.Tables[0].Rows[0][0].ToString());
        }
        public int iKhambenh
        {
            get
            {
                ds = get_data("select ten from " + user + ".bhyt_thongso where id=10 and nhom=0");
                if (ds.Tables[0].Rows.Count == 0) return 0;
                return int.Parse(ds.Tables[0].Rows[0][0].ToString());
            }
        }
        public int iNhombaocao
        {
            get
            {
                ds = get_data("select ten from " + user + ".bhyt_thongso where id=9 and nhom=0");
                if (ds.Tables[0].Rows.Count == 0) return 0;
                return int.Parse(ds.Tables[0].Rows[0][0].ToString());
            }
        }
        ...
        {
            ds = get_data("select ten from " + user + ".d_thongso where id=47 and nhom=1");
        ...
        public string BHXH_VN
        {
            get
            {
                ds = get_data("select ten from " + user + ".bhyt_thongso where id=1 and nhom=0");
        ...
        public string BHXH_TINH
        {
            get
            {
                ds = get_data("select ten from " + user + ".bhyt_thongso where id=2 and nhom=0");
        ...
        public string DV_KCB
        {
            get
            {
                ds = get_data("select ten from " + user + ".bhyt_thongso where id=3 and nhom=0");
                if (ds.Tables[0].Rows.Count == 0) return Tenbv;
                return ds.Tables[0].Rows[0][0].ToString();
            }
        }
        public string MABHXH
        {
            get
            {
                ds = get_data("select ten from " + user + ".bhyt_thongso where id=4 and nhom=0");
                if (ds.Tables[0].Rows.Count == 0) return Tenbv;
                return ds.Tables[0].Rows[0][0].ToString();
            }
        }
        public string MABV_BHYT
        {
            get
            {
                ds = get_data("select ten from " + user + ".bhyt_thongso where id=7 and nhom=0");
                if (ds.Tables[0].Rows.Count == 0) return Tenbv;
                return ds.Tables[0].Rows[0][0].ToString();
            }
        }
        public string MABV_KCB
        {
            get
            {
                ds = get_data("select ten from " + user + ".bhyt_thongso where id=6 and nhom=0");
                if (ds.Tables[0].Rows.Count == 0) return Tenbv;
                return ds.Tables[0].Rows[0][0].ToString();
            }
        }
        public int TRE_EM_DUOI_6
        {
            get
            {
                ds = get_data("select ten from " + user + ".bhyt_thongso where id=8 and nhom=0");
        ...
        public int tutrucpk 
        {
            get
            {
                ds = get_data("select ten from " + user + ".bhyt_thongso where id=12 and nhom=0");
                if (ds.Tables[0].Rows.Count == 0) return 0;
                return int.Parse(ds.Tables[0].Rows[0][0].ToString());
            }
        }
        public bool upd_bhyt_mabaocao(long id, string maloai, string tenloai, string tenmau, string filereport, int iused,int istt, int i_loai,int i_tonghop)
        {
            
            sql = "update " + user + ".bhyt_maubaocao set tenloai=:m_tenloai, ten=:m_ten, filereport=:m_filereport, stt=:m_stt,maloai=:m_maloai,id_form=:m_i_loai";//,tonghop=:i_tonghop ";
            sql += " where id=:m_id";
            con = new OracleConnection(sConn);
            cmd = new OracleCommand(sql, con);
            cmd.CommandType = CommandType.Text;
            cmd.Parameters.Add("m_tenloai", OracleDbType.NVarchar2).Value = tenloai;
            cmd.Parameters.Add("m_ten", OracleDbType.NVarchar2).Value = tenmau;
            cmd.Parameters.Add("m_filereport", OracleDbType.Varchar2, 64).Value = filereport;            
            cmd.Parameters.Add("m_stt", OracleDbType.Decimal).Value = istt;
            cmd.Parameters.Add("m_maloai", OracleDbType.Varchar2).Value = maloai.ToString();
            cmd.Parameters.Add("m_i_loai", OracleDbType.Decimal).Value = i_loai;
            //cmd.Parameters.Add("i_tonghop", OracleDbType.Decimal).Value = i_tonghop;
            cmd.Parameters.Add("m_id", OracleDbType.Decimal).Value = id;
            try
            {
                ...
                {
                    con = new OracleConnection(sConn);
                    sql = "insert into " + user + ".bhyt_maubaocao(id,maloai,tenloai,ten,filereport,stt,id_form) values (:m_id,:m_maloai,:m_tenloai,:m_ten,:m_filereport,:m_stt,:m_i_loai)";
                    cmd = new OracleCommand(sql, con);
                    cmd.CommandType = CommandType.Text;
                    cmd.Parameters.Add("m_id", OracleDbType.Decimal).Value = id;
                    cmd.Parameters.Add("m_maloai", OracleDbType.Varchar2, 64).Value = maloai;
                    cmd.Parameters.Add("m_tenloai", OracleDbType.NVarchar2).Value = tenloai;
                    cmd.Parameters.Add("m_ten", OracleDbType.NVarchar2).Value = tenmau;
                    cmd.Parameters.Add("m_filereport", OracleDbType.Varchar2, 64).Value = filereport;
                    cmd.Parameters.Add("m_stt", OracleDbType.Decimal).Value = istt;
            ...
            {
                upd_error(ex.Message.ToString(), sComputer, "bhyt_maubaocao");
                return false;
            }
            finally
            {
        ...
        public DataSet get_xuat(DataSet ds, DataTable dt, DataTable dtkp, DataTable dtloaint, DataTable dtkhac, DataTable dtkho, string d_tu, string d_den, string d_yy, int d_makho, int d_manguon, int d_nhom)
        {
            ...
            for (int i = i_tu; i <= i_den; i++)
            {
                ...
                if (bMmyy(d_mmyy))
                {
                    ...
                    sql += "a.sophieu as mabn,'Xuất chuyển nguồn' as hoten,to_char(a.ngay,'dd/mm/yyyy') as ngay,0 as loai,b.mabd,sum(b.soluong) as soluong,sum(b.soluong*c.giamua) as sotien";
                    if (bCongdon) sql += ",c.handung";
                    else sql += ",'' as handung";
                    ...
                    if (bDongia) sql += "c.giamua,";
                    if (bCongdon) sql += "c.handung,";
                    sql += "a.sophieu, to_char(a.ngay,'dd/mm/yyyy'), b.mabd";
                    foreach (DataRow r in get_data(sql).Tables[0].Rows)
                    {
                        r1 = getrowbyid(dt, "id=" + int.Parse(r["mabd"].ToString()));
                        if (r1 != null)
        ...
        private DataSet f_get_chandoan_ntcls(string vtungay, string vdenngay, string vschemas, string vmakp,string vmaicds,string vchandoan)
        {
            ...
            sql += " sum(case when d.id>0 then to_date(to_char(d.ngay,'" + sformat + "'),'" + sformat + "')-to_date(to_char(c.ngay,'" + sformat + "'),'" + sformat + "')+1 else 0 end) as songaydt";
            sql += " from (((" + vschemas + ".benhandt a inner join " + vschemas + ".nhapkhoa b on a.maql=b.maql )";
        ...
        private DataSet f_get_cls_khoa(string vschemas, string vtungay, string vdenngay, string sFormat)
        {
            ...
            sql += " inner join " + user + ".xn_bv_ten d on d.id=c.id_bv_ten";
            sql += " inner join " + user + ".xn_bv_so e on d.id_bv_so=e.id";
            sql += " where to_date(to_char(a.ngay,'" + sFormat + "'),'" + sFormat + "') between to_date('" + vtungay + "','" + sFormat + "') and to_date('" + vdenngay + "','" + sFormat + "')";
           ...
           string ngodoc, string dienbien, string xutri, int userid, bool time)
        {
            ...
            if (dotuoi != "")
            {
                ...
                {
                    m_dotuoi = dotuoi.Substring(1);
                    sql += " and to_number(to_char(sysdate,'yyyy'))-to_number(t.namsinh)>" + m_dotuoi;
                }
                else
                {
                    int i1 = int.Parse(dotuoi.Substring(0, dotuoi.IndexOf("-")));
                    int i2 = int.Parse(dotuoi.Substring(dotuoi.IndexOf("-") + 1));
                    sql += " and to_number(to_char(sysdate,'yyyy'),'0000')-to_number(t.namsinh,'0000') between " + i1 + " and " + i2;
                }
            }
        ...
        public bool upd_eve_tables(int m_tableid, int m_userid, string m_command)
        {
            ...
            try
            {
                ...
                cmd = new OracleCommand(sql, con);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add("m_tableid", OracleDbType.Decimal).Value = m_tableid;
                cmd.Parameters.Add("m_ngay", OracleDbType.Varchar2, 10).Value = ngay;
                cmd.Parameters.Add("m_userid", OracleDbType.Decimal).Value = m_userid;
                cmd.Parameters.Add("m_computerid", OracleDbType.Decimal).Value = icomputerid;
                cmd.Parameters.Add("m_ins", OracleDbType.Decimal).Value = m_ins;
                cmd.Parameters.Add("m_upd", OracleDbType.Decimal).Value = m_upd;
                cmd.Parameters.Add("m_del", OracleDbType.Decimal).Value = m_del;
                cmd.ExecuteNonQuery();
            }
            catch (OracleException ex)
            {
        ...
        public bool upd_eve_upd_del(int m_tableid, int m_userid, string m_command, string m_noidung)
        {
            ...
            try
            {
                ...
                cmd.Parameters.Add("m_userid", OracleDbType.Decimal).Value = m_userid;
                cmd.Parameters.Add("m_computerid", OracleDbType.Decimal).Value = icomputerid;
                cmd.Parameters.Add("m_command", OracleDbType.Varchar2, 3).Value = m_command;
                cmd.Parameters.Add("m_noidung", OracleDbType.NVarchar2).Value = m_noidung;
                cmd.ExecuteNonQuery();
            }
            catch (OracleException ex)
            {
        ...
        public string f_Get_String_YYYYMMDD(string m_ngay)
        {
            return m_ngay.Length == 10 ? m_ngay.Substring(6, 4) + m_ngay.Substring(3, 2) + m_ngay.Substring(0, 2) : m_ngay.Substring(6, 4) + m_ngay.Substring(3, 2) + m_ngay.Substring(0, 2) + m_ngay.Substring(11, 2) + m_ngay.Substring(14, 2);
        }

        public string f_Get_DateTimePicker_YYYYMMDD(DateTimePicker dtp)
        {
            return dtp.Value.Year.ToString() + dtp.Value.Month.ToString().PadLeft(2, '0') + dtp.Value.Day.ToString().PadLeft(2, '0');
        }

        public string f_ngaygio24
        {
            get
            {
                return "dd/mm/yy hh24:mi";
        ...
        public DataSet get_Vaophongluu(string tu, string den, string mabn, string hoten, string ngaysinh,
            ...
            string nhantu, string dotuoi, bool icd, int userid, bool time, bool bVaokonhapvien)
        {
            try
            {
                string stime = (time || tu.Trim().Length == 16) ? "yyyymmddhh24mi" : "yyyymmdd";
                ...
                string _tu = f_Get_String_YYYYMMDD(tu);
                string _de = f_Get_String_YYYYMMDD(den);
                hoten = Hoten_khongdau(hoten);
                ...
                sql += "a.namsinh,nvl(a.sonha,' ') sonha,nvl(a.thon,' ') thon,b.tenpxa,c.tenquan,d.tentt,";
                sql += "g.tennn,to_char(f.ngay,'dd/mm/yyyy hh24:mi') as ngay,e.tenkp,h.doituong,";
                ...
                sql += " left join " + user + ".dlogin u on f.userid=u.id";
                if (bVaokonhapvien) sql += " inner join xxx.xutrikbct l on f.maql=l.maql";
                sql += " where f.maql>0";
                if (icd) sql += " and f.maicd in (select ma from " + user + ".dmicd10)";
                //if (tu != "")
                //{
                ...
                if (_tu != "")
                {
                    sql += " and to_char(f.ngay,'" + stime + "') between '" + _tu + "' and '" + _de + "'";
                }
                if (mabn != "") sql += " and a.mabn='" + mabn + "'";
                if (hoten != "") sql += " and a.hotenkdau like '%" + hoten + "%'";
                if (ngaysinh.Trim().Length == 10) sql += " and to_char(a.ngaysinh,'dd/mm/yyyy')='" + ngaysinh + "'";
                ...
                if (nhantu != "") sql += " and f.nhantu=" + nhantu;
                if (userid != -1) sql += " and f.userid=" + userid;
                if (bVaokonhapvien) sql += " and l.maql>0 and instr(l.xutri,'05,')=0";
                if (dotuoi != "")
                {
                    if (dotuoi.IndexOf(">") != -1)
                        sql += " and to_number(to_char(sysdate,'yyyy'),'0000')-to_number(a.namsinh,'0000')>" + int.Parse(dotuoi.Substring(1));
            ...
            string ttlucrk, string dotuoi, bool icd, int userid, bool time, string nhantu)
        {
            try
            {
                ...
                hoten = Hoten_khongdau(hoten);
                sql = "select a.mabn,k.maql,a.hoten,substr(m.tuoivao,1,3)||case when substr(m.tuoivao,4,1)=0 then 'TU' else case when substr(m.tuoivao,4,1)=1 then 'TH' else case when substr(m.tuoivao,4,1)=2 then 'NG' else 'GI' end end end as tuoi,";
                sql += "a.namsinh,nvl(a.sonha,' ') sonha,nvl(a.thon,' ') thon,b.tenpxa,c.tenquan,d.tentt,";
                ...
                sql += "to_date(k.ngayrv,'dd/mm/yy')-to_date(k.ngay,'dd/mm/yy')+1 as ngaydt, ";
                sql += "nvl(y.tenkp,' ') khoanhap,nvl(u.hoten,' ') as tenuser,(l.ten||', '||z.ghichu) as ghichu";
                sql += " from " + user + ".btdbn a inner join " + user + ".btdpxa b on a.maphuongxa=b.maphuongxa";
                sql += " inner join " + user + ".btdquan c on a.maqu=c.maqu";
                sql += " inner join " + user + ".btdtt d on a.matt=d.matt";
                ...
                sql += " left join " + user + ".tuvong z on k.maql=z.maql";
                sql += " left join " + user + ".chetdo l on z.nguyennhan=l.ma";
                sql += " where k.maql>0";
                ...
                if (_tu != "")
                {
                    sql += " and to_char(k.ngayrv,'" + stime + "') between '" + _tu + "' and '" + _de + "'";
                }
                if (mabn != "") sql += " and a.mabn='" + mabn + "'";
                if (hoten != "") sql += " and a.hotenkdau like '%" + hoten + "%'";
                if (ngaysinh.Trim().Length == 10) sql += " and to_char(a.ngaysinh,'dd/mm/yyyy')='" + ngaysinh + "'";
        ...
        public DataSet get_data_acc_nopass(string sql, string thumuc)
        {
            try
            {
                if (ds != null)
                ...
                ds = new DataSet();
                string s = "Provider=Microsoft.Jet.OLEDB.4.0;User Id=;Password=;Data Source=" + thumuc;
        ...
        public bool upd_btdbn_fix(string m_mabn, string m_hoten, string m_ngaysinh, string m_namsinh,
        ...
        {
            string m_userroot = user;
           string  m_hotenkdau = Hoten_khongdau(m_hoten);
            sql = "update " + m_userroot + ".btdbn set hoten=:m_hoten,";
            ...
            cmd = new OracleCommand(sql, con);
            cmd.CommandType = CommandType.Text;
            cmd.Parameters.Add("m_hoten", OracleDbType.NVarchar2, 70).Value = m_hoten;
            if (m_ngaysinh != "") cmd.Parameters.Add("m_ngaysinh", OracleDbType.Date).Value = StringToDateTime(m_ngaysinh);
            cmd.Parameters.Add("m_namsinh", OracleDbType.Varchar2, 4).Value = m_namsinh;
            cmd.Parameters.Add("m_phai", OracleDbType.Decimal).Value = m_phai;
            cmd.Parameters.Add("m_mann", OracleDbType.Varchar2, 2).Value = m_mann;
            cmd.Parameters.Add("m_madantoc", OracleDbType.Varchar2, 2).Value = m_madantoc;
            cmd.Parameters.Add("m_sonha", OracleDbType.NVarchar2, 10).Value = m_sonha;
            cmd.Parameters.Add("m_thon", OracleDbType.NVarchar2, 150).Value = m_thon;
            cmd.Parameters.Add("m_cholam", OracleDbType.NVarchar2, 150).Value = m_cholam;
            cmd.Parameters.Add("m_matt", OracleDbType.Varchar2, 3).Value = m_matt;
            cmd.Parameters.Add("m_maqu", OracleDbType.Varchar2, 5).Value = m_maqu;
            cmd.Parameters.Add("m_maphuongxa", OracleDbType.Varchar2, 7).Value = m_maphuongxa;
            cmd.Parameters.Add("m_userid", OracleDbType.Decimal).Value = m_userid;
            cmd.Parameters.Add("m_hotenkdau", OracleDbType.NVarchar2, 70).Value = m_hotenkdau;
            cmd.Parameters.Add("m_nam", OracleDbType.Varchar2, 500).Value = m_nam;
            cmd.Parameters.Add("m_mabn", OracleDbType.Varchar2).Value = m_mabn;
            try
            {
                con.Open();
                int irec = cmd.ExecuteNonQuery();
        ...
        public bool upd_bc_giavp_th(long d_id, long d_stt, string d_ten, string d_giavp)
        {
            sql = "update bc_giavp_th set stt=:d_stt,ten=:d_ten,giavp=:d_giavp where id=:d_id";
            con = new OracleConnection(sConn);
            cmd = new OracleCommand(sql, con);
            cmd.CommandType = CommandType.Text;
            cmd.Parameters.Add("d_stt", OracleDbType.Decimal, 2).Value = d_stt;
            cmd.Parameters.Add("d_ten", OracleDbType.NVarchar2, 250).Value = d_ten;
            cmd.Parameters.Add("d_giavp", OracleDbType.NVarchar2, 4000).Value = d_giavp;
            cmd.Parameters.Add("d_id", OracleDbType.Decimal).Value = d_id;
            ...
            try
            {
                ...
                if (irec == 0)
                {
                    sql = "insert into " + user + ".bc_giavp_th (stt,ten,giavp,id) values (:d_stt,:d_ten,:d_giavp,:d_id)";
                    cmd = new OracleCommand(sql, con);
                    cmd.CommandType = CommandType.Text;
                    cmd.Parameters.Add("d_stt", OracleDbType.Decimal, 2).Value = d_stt;
                    cmd.Parameters.Add("d_ten", OracleDbType.NVarchar2, 250).Value = d_ten;
                    cmd.Parameters.Add("d_giavp", OracleDbType.Varchar2, 4000).Value = d_giavp;
                    cmd.Parameters.Add("d_id", OracleDbType.Decimal).Value = d_id;
                    cmd.ExecuteNonQuery();
                    cmd.Dispose();
                }
            ...
            {
                upd_error(ex.Message, sComputer, "bc_giavp_th");
                return false;
            }
            finally
            {
        ...
        public bool upd_bc_giavp_th(long d_id, long d_stt, string d_ten, long d_giavp)
        {
            sql = "update bc_giavp_th set ten=:d_ten where id=:d_id and giavp=:d_giavp and stt=:d_stt";
            con = new OracleConnection(sConn);
            cmd = new OracleCommand(sql, con);
            cmd.CommandType = CommandType.Text;
            cmd.Parameters.Add("d_ten", OracleDbType.NVarchar2, 250).Value = d_ten;
            cmd.Parameters.Add("d_id", OracleDbType.Decimal).Value = d_id;
            cmd.Parameters.Add("d_giavp", OracleDbType.Decimal, 8).Value = d_giavp;
            cmd.Parameters.Add("d_stt", OracleDbType.Decimal, 2).Value = d_stt;
        ...
        public bool upd_bc_giavp_th(long d_id, long d_stt, string d_ten, long d_giavp, string d_makp)
        {
            sql = "update bc_giavp_th set ten=:d_ten,makp=:d_makp where id=:d_id and giavp=:d_giavp and stt=:d_stt";
            con = new OracleConnection(sConn);
            cmd = new OracleCommand(sql, con);
            cmd.CommandType = CommandType.Text;
            cmd.Parameters.Add("d_ten", OracleDbType.NVarchar2, 250).Value = d_ten;
            cmd.Parameters.Add("d_makp", OracleDbType.NVarchar2, 2).Value = d_makp;
            cmd.Parameters.Add("d_id", OracleDbType.Decimal).Value = d_id;
            cmd.Parameters.Add("d_giavp", OracleDbType.Decimal, 8).Value = d_giavp;
            cmd.Parameters.Add("d_stt", OracleDbType.Decimal, 2).Value = d_stt;
            ...
            try
            {
                ...
                if (irec == 0)
                {
                    sql = "insert into " + user + ".bc_giavp_th (stt,ten,makp,giavp,id) values (:d_stt,:d_ten,:d_makp,:d_giavp,:d_id)";
                    cmd = new OracleCommand(sql, con);
                    cmd.CommandType = CommandType.Text;
                    cmd.Parameters.Add("d_stt", OracleDbType.Decimal, 2).Value = d_stt;
                    cmd.Parameters.Add("d_ten", OracleDbType.NVarchar2, 250).Value = d_ten;
        ...
        public bool upd_bc_giavp_th(long d_id, long d_stt, string d_ten, long d_giavp, string d_makp, long d_manhomkp)
        {
            sql = "update bc_giavp_th set ten=:d_ten,makp=:d_makp,manhomkp=:d_manhomkp where id=:d_id and giavp=:d_giavp and stt=:d_stt";
            con = new OracleConnection(sConn);
            cmd = new OracleCommand(sql, con);
            cmd.CommandType = CommandType.Text;
            cmd.Parameters.Add("d_ten", OracleDbType.NVarchar2, 250).Value = d_ten;
            cmd.Parameters.Add("d_makp", OracleDbType.NVarchar2, 2).Value = d_makp;
            cmd.Parameters.Add("d_manhomkp", OracleDbType.Decimal, 2).Value = d_manhomkp;
            cmd.Parameters.Add("d_id", OracleDbType.Decimal).Value = d_id;
            cmd.Parameters.Add("d_giavp", OracleDbType.Decimal, 8).Value = d_giavp;
            cmd.Parameters.Add("d_stt", OracleDbType.Decimal, 2).Value = d_stt;
            ...
            try
            {
                ...
                if (irec == 0)
                {
                    sql = "insert into " + user + ".bc_giavp_th (stt,ten,makp,manhomkp,giavp,id) values (:d_stt,:d_ten,:d_makp,:d_manhomkp,:d_giavp,:d_id)";
                    cmd = new OracleCommand(sql, con);
                    cmd.CommandType = CommandType.Text;
                    cmd.Parameters.Add("d_stt", OracleDbType.Decimal, 2).Value = d_stt;
                    cmd.Parameters.Add("d_ten", OracleDbType.NVarchar2, 250).Value = d_ten;
        ...
        public bool upd_chandoan_bhytkb(string s_userroot,string s_mmyy, long s_id, string s_chandoan, string s_maicd)
        {
            con = new OracleConnection(sConn);
            sql = "update " +s_userroot + s_mmyy + ".bhytkb set maicd=:s_maicd, chandoan=:s_chandoan where id=:s_id ";
            cmd = new OracleCommand(sql, con);
            cmd.CommandType = CommandType.Text;
            
            cmd.Parameters.Add("s_maicd", OracleDbType.NVarchar2, 9).Value = s_maicd;
            cmd.Parameters.Add("s_chandoan", OracleDbType.NVarchar2, 254).Value = s_chandoan;
            cmd.Parameters.Add("s_id", OracleDbType.Decimal).Value = s_id;
            try
            {
                if(con.State==ConnectionState.Closed) con.Open();
                cmd.ExecuteNonQuery();
        ...
        public bool upd_chandoan_bhytkb_maicd(string s_userroot, string s_mmyy, long s_id, string s_chandoan, string s_maicd)
        {
            con = new OracleConnection(sConn);
            sql = "update " + s_userroot + s_mmyy + ".bhytkb set chandoan=:s_chandoan, maicd=:s_maicd  where id=:s_id";
            cmd = new OracleCommand(sql, con);
            cmd.CommandType = CommandType.Text;
        ...
        public bool upd_v_ttrvds(string s_userroot, string s_mmyy, decimal v_id, string v_chandoan, string v_maicd)
        {
            sql = "update " + s_userroot + s_mmyy + ".v_ttrvds set chandoan=:v_chandoan, maicd=:v_maicd where id=:v_id";
            con = new OracleConnection(sConn);
            cmd = new OracleCommand(sql, con);
            cmd.CommandType = CommandType.Text;

            cmd.Parameters.Add("v_chandoan", OracleDbType.NVarchar2, 254).Value = v_chandoan;
            cmd.Parameters.Add("v_maicd", OracleDbType.Varchar2, 9).Value = v_maicd;
            cmd.Parameters.Add("v_id", OracleDbType.Decimal).Value = v_id;
        ...
        public bool upd_v_ttrvds_maicd(string s_userroot, string s_mmyy, decimal v_id, string v_chandoan, string v_maicd)
        {
            sql = "update " + s_userroot + s_mmyy + ".v_ttrvds set chandoan=:v_chandoan, maicd=:v_maicd where id=:v_id";
            con = new OracleConnection(sConn);
            cmd = new OracleCommand(sql, con);
        ...
        public bool upd_bc_loaivpnhom(long d_id, long d_stt, string d_ten, long d_loaivp, long d_idmau)
        {
            sql = "update bc_loaivpnhom set ten=:d_ten, stt=:d_stt where loaivp=:d_loaivp and id=:d_id and idmau=:d_idmau";
            con = new OracleConnection(sConn);
            cmd = new OracleCommand(sql, con);
            cmd.CommandType = CommandType.Text;
            cmd.Parameters.Add("d_ten", OracleDbType.NVarchar2, 250).Value = d_ten;
            cmd.Parameters.Add("d_stt", OracleDbType.Decimal, 2).Value = d_stt;
            cmd.Parameters.Add("d_loaivp", OracleDbType.Decimal).Value = d_loaivp;
            cmd.Parameters.Add("d_id", OracleDbType.Decimal).Value = d_id;
            cmd.Parameters.Add("d_idmau", OracleDbType.Decimal).Value = d_idmau;
            ...
            try
            {
                ...
                if (irec == 0)
                {
                    sql = "insert into " + user + ".bc_loaivpnhom (ten,stt,loaivp,id,idmau) values (:d_ten,:d_stt,:d_loaivp,:d_id,:d_idmau)";
                    cmd = new OracleCommand(sql, con);
                    cmd.CommandType = CommandType.Text;
                    cmd.Parameters.Add("d_ten", OracleDbType.NVarchar2, 250).Value = d_ten;
                    cmd.Parameters.Add("d_stt", OracleDbType.Decimal, 2).Value = d_stt;
            ...
            {
                upd_error(ex.Message, sComputer, "bc_loaivpnhom");
                return false;
            }
            finally
            {
        ...
        public bool upd_bc_diemthu(long d_id, long d_stt, string d_ten)
        {
            sql = "update bc_diemthu set ten=:d_ten , stt=:d_stt where id=:d_id";
            con = new OracleConnection(sConn);
            cmd = new OracleCommand(sql, con);
            cmd.CommandType = CommandType.Text;
            cmd.Parameters.Add("d_ten", OracleDbType.NVarchar2, 250).Value = d_ten;
            ...
            try
            {
                ...
                if (irec == 0)
                {
                    sql = "insert into " + user + ".bc_diemthu (ten,stt,id) values (:d_ten,:d_stt,:d_id)";
                    cmd = new OracleCommand(sql, con);
                    cmd.CommandType = CommandType.Text;
                    cmd.Parameters.Add("d_ten", OracleDbType.NVarchar2, 250).Value = d_ten;
                    cmd.Parameters.Add("d_stt", OracleDbType.Decimal, 2).Value = d_stt;
            ...
            {
                upd_error(ex.Message, sComputer, "bc_diemthu");
                return false;
            }
            finally
            {
        ...
        public bool upd_bc_dmmau(long d_id, long d_stt, string d_ten)
        {
            sql = "update bc_dmmau set ten=:d_ten , stt=:d_stt where id=:d_id";
            con = new OracleConnection(sConn);
            cmd = new OracleCommand(sql, con);
            cmd.CommandType = CommandType.Text;
            cmd.Parameters.Add("d_ten", OracleDbType.NVarchar2, 250).Value = d_ten;
            ...
            try
            {
                ...
                if (irec == 0)
                {
                    sql = "insert into " + user + ".bc_dmmau (ten,stt,id) values (:d_ten,:d_stt,:d_id)";
                    cmd = new OracleCommand(sql, con);
                    cmd.CommandType = CommandType.Text;
                    cmd.Parameters.Add("d_ten", OracleDbType.NVarchar2, 250).Value = d_ten;
                    cmd.Parameters.Add("d_stt", OracleDbType.Decimal, 2).Value = d_stt;
        ...
        public bool upd_nhanthe_bhyt_theodoi(string d_mabn, decimal d_maql, long d_userid, string d_ngaynhanthe, string d_ngaytrathe, int d_muon, string d_nguoinhan, string d_ngaymuonthe)
        {
            string s1 = onlyso(d_ngaynhanthe.Trim()).Trim();
            string s2 = onlyso(d_ngaytrathe.Trim()).Trim();
            string s3 = onlyso(d_ngaymuonthe.Trim()).Trim();
            sql = "update " + user + ".bhyt_theodoi set userid=:d_userid";
            if (s1.Length > 0) sql += ", ngaynhanthe=:d_ngaynhanthe";
            else sql += ", ngaynhanthe=null";
            if (s2.Length > 0) sql += ", ngaytrathe=:d_ngaytrathe";
            else sql += ", ngaytrathe=null";
            if (s3.Length > 0) sql += ", ngaymuonthe=:d_ngaymuonthe";
            else sql += ", ngaymuonthe=null";
            sql += ", muon=:d_muon, ghichu=:d_nguoinhan";
            sql += " where mabn=:d_mabn and maql=:d_maql";
            con = new OracleConnection(sConn);
            cmd = new OracleCommand(sql, con);
            cmd.CommandType = CommandType.Text;
            cmd.Parameters.Add("d_userid", OracleDbType.Decimal, 3).Value = d_userid;
            if (s1.Length > 0) cmd.Parameters.Add("d_ngaynhanthe", OracleDbType.Date).Value = StringToDateTime(d_ngaynhanthe);
            if (s2.Length > 0) cmd.Parameters.Add("d_ngaytrathe", OracleDbType.Date).Value = StringToDateTime(d_ngaytrathe);
            if (s3.Length > 0) cmd.Parameters.Add("d_ngaymuonthe", OracleDbType.Date).Value = StringToDateTime(d_ngaymuonthe);
            cmd.Parameters.Add("d_muon", OracleDbType.Decimal, 1).Value = d_muon;
            cmd.Parameters.Add("d_nguoinhan", OracleDbType.NVarchar2).Value = d_nguoinhan;
            cmd.Parameters.Add("d_mabn", OracleDbType.Varchar2).Value = d_mabn;
            cmd.Parameters.Add("d_maql", OracleDbType.Decimal, 18).Value = d_maql;
            ...
            try
            {
                ...
                if (irec == 0)
                {
                    sql = "insert into " + user + ".bhyt_theodoi (userid";
                    sql += ", ngaynhanthe";
                    sql += ", ngaytrathe";
                    sql += ", ngaymuonthe";
                    sql +=",muon,ghichu,mabn,maql)";
                    sql += " values(:d_userid";
                    if (s1.Length > 0) sql += ", :d_ngaynhanthe";
                    else sql += ", null";
                    if (s2.Length > 0) sql += ", :d_ngaytrathe";
                    else sql += ", null";
                    if (s3.Length > 0) sql += ", :d_ngaymuonthe";
                    else sql += ", null";
                    sql += ", :d_muon, :d_nguoinhan, :d_mabn, :d_maql)";
                    cmd = new OracleCommand(sql, con);
                    cmd.CommandType = CommandType.Text;
                    cmd.Parameters.Add("d_userid", OracleDbType.Decimal, 3).Value = d_userid;
                    if (s1.Length > 0) cmd.Parameters.Add("d_ngaynhanthe", OracleDbType.Date).Value = StringToDateTime(d_ngaynhanthe);
            ...
            {
                upd_error(ex.Message, sComputer, "bhyt_theodoi");
                return false;
            }
            finally
            {
        ...
        public string f_Get_Id_Hoantra(string tu, string den)
        {
            string id = "";
            string d_tu = StringToDate(tu).AddMonths(-1).ToString("dd/MM/yyyy", null);
            string d_den = StringToDate(den).AddMonths(1).ToString("dd/MM/yyyy", null);
            sql = "select a.id from xxx.v_ttrvll a , xxx.v_hoantra b where a.quyenso=b.quyenso and  a.sobienlai=b.sobienlai and to_date(a.ngay,'dd/mm/yy') between to_date('" + d_tu + "','dd/mm/yy') and to_date('" + d_den + "','dd/mm/yy')";

            try
            {
                foreach (DataRow r in get_data_mmyy(sql, tu, den, false).Tables[0].Rows) id += r["id"].ToString() + ",";
            }
            catch
            {
            }
        ...
        public DataSet get_Khambenh(string tu, string den, string mabn, string hoten, string ngaysinh,
            ...
            string mabs, int loai, int bnmoi, string loaidt, string sothe, bool bngoaitru)
        {
            ...
            hoten = Hoten_khongdau(hoten);
            sql = "SELECT 0 as chon,a.MABN,f.maql,a.HOTEN,substr(k.tuoivao,1,3)||case when substr(k.tuoivao,4,1)=0 then 'TU' else case when substr(k.tuoivao,4,1)=1 then 'TH' else case when substr(k.tuoivao,4,1)=2 then 'NG' else 'GI' end end end as tuoi, a.NAMSINH, nvl(a.SONHA,'') as sonha,";
            sql += "nvl(a.THON,' ') as thon, b.TENPXA, c.TENQUAN, d.TENTT, g.TENNN, trim(nvl(a.SONHA,'')||' '||nvl(a.THON,' ')||' '||b.tenpxa||', '||c.tenquan||', '||d.tentt||'.')as sonha, to_char(f.ngay,'dd/mm/yyyy hh24:mi') AS ngay,";
            sql += "e.TENKP, h.DOITUONG, f.CHANDOAN, f.MAICD, f.SOVAOVIEN, i.TEN AS nhantu,j.TEN AS dentu, n.TEN AS xutri,k.soluutru,nvl(y.tenkp,' ') as khoanhap,nvl(to_char(z.ngaysanh,'dd/mm/yyyy'),' ') as ngaysanh,nvl(p.hoten,' ') as tenbs,nvl(u.hoten,' ') as tenuser,nvl(l.sothe,' ') as sothe,v.tenbv ";
            ...
            if (tu != "")
                sql += " and " + for_ngay("f.ngay", stime) + " between to_date('" + tu + "'," + stime + ") and to_date('" + den + "'," + stime + ")";
            //{
            //    if (time) sql += " and f.ngay between to_date('" + tu + "'," + stime + ") and to_date('" + den + "'," + stime + ")";
        ...
        public string f_GetSql(string asql, string vtu, string vden)
        {
            DateTime dt1 = StringToDate(vtu).AddMonths(-1);
            DateTime dt2 = StringToDate(vden);
            int y1 = dt1.Year, m1 = dt1.Month;
            int y2 = dt2.Year, m2 = dt2.Month;
            int itu, iden;
            string mmyy = "", tmp = "", m_useroot = user.ToString().ToLower();
            for (int i = y1; i <= y2; i++)
            {
                itu = (i == y1) ? m1 : 1;
                iden = (i == y2) ? m2 : 12;
                for (int j = itu; j <= iden; j++)
                {
                    ...
                    if (bMmyy(mmyy))
                    {
                        tmp += tmp == "" ? tmp : " union all ";
                        tmp += asql.Replace("zzz.", m_useroot + mmyy + ".");
                    }
                }
            }
            return tmp;
        ...
        #region Dinh Son fix dung cho bhyt 01/10/2009
        /// <summary>
        /// Lấy vị trí sẽ tìm thông tin thẻ. Hiện tại áp dụng cho thẻ có chiều dài 15 ký tự
        /// </summary>
        ...
        public string ma13_vitri_fix(int d_nhom)
        {
            ...
            if (ds.Tables[0].Rows.Count == 0) return "3,1";
            return ds.Tables[0].Rows[0][0].ToString().Trim();
        }
        ...
        public int get_maphu(string sothe, int inhom)
        {
            try
            {
                string ma13 = ma13_vitri_fix(inhom).ToString(), ma16 = ma16_vitri_fix(inhom).ToString();
                ...
                if (sothe.Trim().Length == 18)
                    return (ma16_ngtru_fix.IndexOf(sothe.Trim().Substring(m161, m162)) != -1) ? 1 : 0;
                else
        ...
        public int f_get_maquyenloi_ngoaitru(string sothe, decimal sotien, int nhom)
        {
            string ma13 = ma13_vitri_fix(nhom).ToString(), ma16 = ma16_vitri_fix(nhom).ToString();
            int m131 = 4, m132 = 1, m161 = 4, m162 = 2, pos = 0;
            decimal m13_st = ma13_st_fix(nhom), m16_st = ma16_st_fix(nhom);
            try
            {
                if (ma13 != "")
                {
        ...
        /// <summary>
        /// Lấy vị trí sẽ tìm thông tin thẻ. Hiện tại áp dụng cho thẻ có chiều dài 18 ký tự
        /// </summary>
        /// <param name="d_nhom"></param>
        /// <returns></returns>
        public string ma16_vitri_fix(int d_nhom)
        {
            ...
            if (ds.Tables[0].Rows.Count == 0) return "14,2";
            return ds.Tables[0].Rows[0][0].ToString().Trim();
        }

        /// <summary>
        /// Lấy số tiền dùng thẻ 15 ký tự
        /// </summary>
        /// <param name="d_nhom"></param>
        /// <returns></returns>
        public decimal ma13_st_fix(int d_nhom)
        {
            ds = get_data("select ten from d_thongso where id=50 and nhom=" + d_nhom);
            if (ds.Tables[0].Rows.Count == 0) return 10000;
            return decimal.Parse(ds.Tables[0].Rows[0][0].ToString());
        }

        /// <summary>
        /// Lấy số tiền dùng thẻ 18 ký tự
        /// </summary>
        /// <param name="d_nhom"></param>
        /// <returns></returns>
        public decimal ma16_st_fix(int d_nhom)
        {
        ...
        /// <summary>
        /// Lấy thông số của thẻ 15 ký tự đối với trường hợp 80%
        /// </summary>
