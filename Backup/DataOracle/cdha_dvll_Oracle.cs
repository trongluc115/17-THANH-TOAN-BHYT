...
namespace DataOracle
{
    public class cdha_dvll_Oracle
    {
        ...
        public DataTable f_getBAOCAO_CDHA_PHIM(DateTime tungay, DateTime denngay, string s_noithuchien)
        {
            AccessData data = new AccessData();
            DataSet ds = new DataSet();
            DataTable dt = new DataTable();
        ...
        public DataTable f_getBAOCAO_CDHA_M02_dathuchien(DateTime tungay, DateTime denngay, string s_noithuchien)
        {
            AccessData data = new AccessData();
            DataSet ds = new DataSet();
            DataTable dt = new DataTable();
