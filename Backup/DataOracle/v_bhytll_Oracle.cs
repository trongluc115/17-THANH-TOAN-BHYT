    ...
    public class v_bhytll_Oracle
    {
              ...
              try
                {
                    ...
                    //PHAU THUAT KTC
                    sql = "insert into " + schema + ".v_bhytll(ID,DIEMTHU,LOAIBN,LOAI,QUYENSO,SOBIENLAI,NGAY,MAKP,SOTIEN,TAMUNG,MIEN,";
        ...
        public int f_delete(long id)
        {
            ...
            try
            {
                ...
                string userid = AccessData.m_userid;
                //delete
                sql = "delete " + schema + ".v_bhytll where id={id} ";
