    ...
    public class e_bhytds_Oracle
    {
        ...
        public int f_insert(v_bhytds obj)
        {
            ...
            try
            {
                ...
                //PHAU THUAT KTC
                sql = "insert into "+schema+".e_bhytds(ID,MABN,MAVAOVIEN,MAQL,IDKHOA,GIUONG,NGAYVAO,NGAYRA,CHANDOAN, ";
                ...
                eve_log.Action = "INSERT";
                eve_log.Content =schema +  ".E_BHYTDS_"+obj.ID + "_" + obj.MABN + "_" + obj.SOTHE + "_" + obj.MAVAOVIEN;
        ...
        public int f_delete(long id,CThanhToanBHYT thanhtoan)
        {
            int result = 0;
            try
            {
                ...
                string userid = AccessData.m_userid;
                //delete
                sql = "delete "+schema+".e_bhytds where id={id} ";
                sql = sql.Replace("{id}", id.ToString());
                result = OracleData.f_execute_data(sql);
                

                eve_log.Action = "DELETE";
                eve_log.Content = schema + ".E_BHYTDS_" + id.ToString() + "_" + thanhtoan.MaBN + "_" + thanhtoan.SoTheBHYT;
                eve_logDAO.f_insert(eve_log);
        ...
        public int f_update(v_bhytds obj)
        {
            ...
            try
            {
                ...
                sql += " ,sothe={SOTHE},TUNGAY=TO_DATE('{TUNGAY}','dd/MM/yyyy'),DENNGAY=TO_DATE('{DENNGAY}','dd/MM/yyyy')";
                sql += " where id={ID} ";
        ...
        public int f_updateduyetkhth(string id,string value)
        {
            int result = 0;
            try
            {
                ...
                sql = sql.Replace("{DUYETKHTH}", value);
