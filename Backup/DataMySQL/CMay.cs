    ...
    public class CMay
    {
        ...
        public DataSet get_DSMay(string timkiem)
        {
            ...
            try
            {
                ...
                sql = " select a.id,a.mamay,a.ten,b.ten,c.ten,a.Vitri,e.Ten,f.Ten,a.DonGia,g.ten,a.ngaybdsd ";
        ...
        public DataSet get_DSMay()
        {
            ...
            try
            {
                ...
                sql = " select a.id id,a.mamay barcode,a.ten tenmay,b.ten nuocsx,c.ten khoaphong,a.Vitri vitri,e.Ten loai,f.Ten loaichitiet,a.DonGia,g.ten tinhtrang,a.ngaybdsd tungay ";
                sql += "from may a,dmquocgia b,dmkhoaphong c,dmloaimay e,dmloaichitiet f,dmtinhtrang g ";
                sql += " where a.NuocSX=b.ID and a.MaKP=c.ID and a.MaLoai=e.ID and a.tinhtrang=g.id and a.LoaiChiTiet=f.ID";
        ...
        public DataSet get_cauhinh(string id)
        {
            ...
            try
            {
                ...
                sql = "select a.matb,b.ten,a.noidung from cauhinh a,dmthietbi b where a.matb=b.id and a.id='" + id+"'";
